...
V_l_i   = 2000;             % initial liquid volume (L)
V_g_i   = 8000;             % initial gas volume (L)

%Fin_l   = 4000;            % liquid flow rate (L/h)
Fin_l    = 0; % Start at zero

%Fin_g   = 60;              % gas flow rate (L/h) 
Vtot    = 10000;            % total volume (L)
VL_max    = 7500;           % maximum liquid volume (L)
...
Xi      = 0.05;                    % Initial biomass concentration (g/L)
